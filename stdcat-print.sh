...
echo "Caution: Use of a parenthesis. This does NOT work in Bash."
...
echo "******"
echo -e "Warning! Use of parentheses with /bin/bash does not work correctly. It works with /bin/sh only"
echo "******"
